                  ...
                  <div className="relative px-4 flex-auto">
                      <div className="my-4 text-[clamp(22px,3vw,36px)] leading-relaxed font-light font-['Lilita_One']">
                        <ul className="list-disc px-8 text-sm lg:text-xl font-['Poppins']">
                            ...
                            <li className="my-4">Featuring your own profile, the ability to add/update/delete entries, upload receipts, save your vehicle's information <em><strong>AND</strong></em> an Excel download, get your records digitised today!</li>
