                  ...
                  <div className="relative px-4 flex-auto">
                      <div className="my-4 text-[clamp(22px,3vw,36px)] leading-relaxed font-light font-['Lilita_One']">
                        <ul className="list-disc px-8 text-sm lg:text-xl font-['Poppins']">
                            ...
                            <li className="my-4">Featuring your very own profile, saving pertinent vehicle information, add/update/delete maintenance records <em>AND</em> an Excel download, get your record keeping started today!</li>
                            ...
                            <motion.div 
                              ...
                              <div className="lg:flex">
                                    ...
                                    <span className="material-symbols-outlined text-[32px]">rocket_launch</span>
                                        <a href="https://cartificate.vercel1.app/" target="_blank">
