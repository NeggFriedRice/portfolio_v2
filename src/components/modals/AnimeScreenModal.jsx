                    ...
                    <div className="relative p-6 flex-auto">
                      <div className="my-4 leading-relaxed font-light font-['Lilita_One']">
                        <ul className="list-disc px-4 text-md lg:text-lg font-['Poppins']">
                            ...
                            <p className="my-4 text-[0.9rem] bg-slate-500 p-2 rounded">Note: Not all features are functional as we have been limited to using free trial services and we're too cheap to pay to keep the app running (MongoDB, AWS, Google maps APIs).</p>
