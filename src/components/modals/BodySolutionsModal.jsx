...
export default function BodySolutionsModal() {
      ...
      <div className="flex">
        ...
        >
          ...
          <AnimatePresence>
            {showModal && (
            <>
              <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none overflow-hidden">
            <motion.div
              variants={{
                  ...
                  <div className="relative px-4 flex-auto">
                      <div className="my-4 text-[clamp(22px,3vw,36px)] leading-relaxed font-light font-['Lilita_One']">
                        <ul className="list-disc px-8 text-sm lg:text-xl font-['Poppins']">
                            <li className="my-4">Body Solutions PDR did not have an official website attached to their Google business info that would show up as a Google Maps business; this single page application was designed to satisfy this need.</li>
                            <li className="my-4">Designed to client's requirements, as well as featuring an online quote form to send customers' information and a photo directly to the client's email.</li>
                            ...
                            <motion.div 
                              ...
                              <div className="lg:flex">
                                    ...
                                    <a href="https://github.com/NeggFriedRice/body-solutions-pdr" target="_blank">
