...
export default function AnimeScreenModal() {
    ...
    <>
      ...
      >
        {/* <span className="relative flex top-[1px] right-[12px] h-5 w-5 ">
          ...
          <span className="relative inline-flex  h-5 w-5 bg-green-500 hover:bg-blue-500 hover:rotate-360 transition-all duration-500"></span>
        </span> */}
                    ...
                    <div className="relative p-6 flex-auto">
                      <div className="my-4 leading-relaxed font-light font-['Lilita_One']">
                        <ul className="list-disc px-4 text-lg font-['Poppins']">
                            <li className="my-4">With our group sharing a common interest dabbling in anime, we went forth and built an event scheduler centered around anime events for anime connoiseurs around the world.</li>
                            ...
                            <p className="my-4 text-[0.8rem]">Note: Not all features are still available and functional as we have been limited to using free trial services in some cases (MongoDB, AWS, Google maps APIs).</p>
                            ...
                            <motion.div 
                                ...
                                <span className="material-symbols-outlined text-[clamp(26px, 3vh, 40px)]">rocket_launch</span>
                                ...
                                <a href="https://github.com/NeggFriedRice/T3A2-B-Frontend" target="_blank">
                                <p className="mx-2 text-[12px] md:text-[1rem]">View GitHub repo</p>
                                </a>
                                </div>
                            </motion.div>
