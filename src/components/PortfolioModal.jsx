                    ...
                    <div className="relative p-6 flex-auto">
                      <div className="my-4 text-[clamp(22px,3vw,36px)] leading-relaxed font-light font-['Lilita_One']">
                        <ul className="list-disc px-4 text-lg font-['Poppins']">
                            <li className="my-4">As someone fairly new to the world of web development I've always wondered how things were built. Now that I've got some inkling of what it takes, <em>sheeesh</em>, it's been a bit of a ride and I'm only just getting started.</li>
                            ...
                            <a href="https://github.com/NeggFriedRice/portfolio_v2" target="_blank">
