    ...
    <div className="flex justify-end px-4 absolute right-1">
        <div className="">
            <div className="py-2 hover:scale-[90%] transition-all delay-100 duration-300">
                ...
                <svg className="h-[25px]" viewBox="0 0 128 128">
            ...
            <div className="py-2">
              <img className="h-[25px]" src="email.svg" />
              <p className="absolute right-[-65px] top-[205px] rotate-90 text-white font-medium">tomloo222@gmail.com</p>
            </div>
        </div>
    </div>
  )
