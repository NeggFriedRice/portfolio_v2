        ...
        <div className="fixed">
            <div className="py-2 hover:scale-[90%] transition-all delay-100 duration-300 hover:opacity-60">
                ...
                <motion.svg 
                  initial={{ x: 100 }}
                  animate={{ x: 0 }}
                  transition={{ delay: 3, duration: 2, type: 'spring', stiffness: 200 }}
                  className="h-[35px] lg:h-[60px]" viewBox="0 0 128 128">
            ...
            <div className="py-2 hover:scale-[90%] transition-all delay-100 duration-300 hover:opacity-60">
                ...
                <motion.svg
                  initial={{ x: 100 }}
                  animate={{ x: 0 }}
                  transition={{ delay: 3.1, duration: 2, type: 'spring', stiffness: 200}}
                 className="h-[35px] lg:h-[60px]" viewBox="0 0 128 128">
