            ...
            <div className="xl:w-[50vw] lg:w-[70vw] w-[100vw]">
                ...
                <div className="py-6 flex justify-center">
                    <div className="w-[80vw] md:grid md:grid-cols-2 flex flex-wrap justify-center">
                        <p className="py-2 col-start-1 col-span-2 text-[1.3rem] lg:text-[1.6rem]">A bright-eyed 👀, squash-playing 🎾, car-enthusiast 🚗 junior full stack web developer that likes tinkering with code and creating something <em>a little bit special</em>.</p>
                        <div>
