  ...
  return (
    ...
    <div className="flex justify-center items-center my-4">
      <a href="https://github.com/NeggFriedRice/CramHub" target="_blank">
       <video autoPlay loop muted src="/videos/cramhub.mp4" width="300" height="300" className="shadow-block-md hover:shadow-block-lg hover:scale-105 hover:rounded-lg transition-all duration-300 delay-100 border-r-1 border-b-1 border-slate-600"/>
       </a>
    </div>
